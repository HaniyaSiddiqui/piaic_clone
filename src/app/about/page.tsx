    ...
    return (
        <div className=' bg-slate-200 '>
            ...
            <div className=' mt-30  '>
                ...
                <Wrapper>
                    <div className=" mt-20 " >
                        <div className="h-40 w-40  text-center rounded-full border-4 border-green-500 overflow-hidden item-center ml-[35%]  md:ml-[40%] lg:ml-[45%] ">
                    ...
                    <div className=' relative px-10 text-gray-800'>
